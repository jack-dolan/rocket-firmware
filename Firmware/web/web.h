...
#ifndef FAKE_DAQ_THREAD_PORT
#define FAKE_DAQ_THREAD_PORT    3456
#endif
...
extern THD_WORKING_AREA(wa_test_ip, WEB_THREAD_STACK_SIZE);
extern THD_WORKING_AREA(wa_udp_recv, WEB_THREAD_STACK_SIZE);
